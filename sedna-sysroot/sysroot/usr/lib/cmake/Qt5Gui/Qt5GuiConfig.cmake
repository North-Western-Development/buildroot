...
set(Qt5Gui_VERSION_STRING 5.15.14)
...
if (NOT TARGET Qt5::Gui)
    ...
    set(Qt5Gui_PRIVATE_INCLUDE_DIRS
        "${_qt5Gui_install_prefix}/include/qt5/QtGui/5.15.14"
        "${_qt5Gui_install_prefix}/include/qt5/QtGui/5.15.14/QtGui"
    )
    ...
    foreach(_module_dep ${_Qt5Gui_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.14 ${_Qt5Gui_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::Gui
                 ...
                 evdev;freetype;ico;imageio-text-loading;linuxfb;multiprocess;raster-64bit;system-freetype;tuiotouch;vnc)
    set_property(TARGET Qt5::Gui
                 PROPERTY QT_DISABLED_PRIVATE_FEATURES
                 xcb;accessibility-atspi-bridge;angle_d3d11_qdtd;direct2d;direct2d1_1;dxgi;direct3d11;direct3d11_1;direct3d9;directfb;drm_atomic;dxgi1_2;dxguid;egl;egl_x11;eglfs;eglfs_brcm;eglfs_egldevice;eglfs_gbm;eglfs_mali;eglfs_openwfd;eglfs_rcar;eglfs_viv;eglfs_viv_wl;eglfs_vsp2;eglfs_x11;fontconfig;gif;harfbuzz;integrityfb;integrityhid;jpeg;kms;libinput;libinput-axis-api;mtdev;png;system-harfbuzz;system-jpeg;system-png;tslib;vkgen;vsp2;xlib;xcb-xlib;xkbcommon;xkbcommon-x11)
    ...
    _populate_Gui_target_properties(RELEASE "libQt5Gui.so.5.15.14" "" FALSE)
