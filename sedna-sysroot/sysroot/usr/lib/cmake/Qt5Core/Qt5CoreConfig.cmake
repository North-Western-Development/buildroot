...
set(Qt5Core_VERSION_STRING 5.15.14)
...
if (NOT TARGET Qt5::Core)
    ...
    set(Qt5Core_PRIVATE_INCLUDE_DIRS
        "${_qt5Core_install_prefix}/include/qt5/QtCore/5.15.14"
        "${_qt5Core_install_prefix}/include/qt5/QtCore/5.15.14/QtCore"
    )
    ...
    foreach(_module_dep ${_Qt5Core_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.14 ${_Qt5Core_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::Core
                 ...
                 clock-gettime;datetimeparser;doubleconversion;futimens;getauxval;getentropy;hijricalendar;inotify;linkat;mimetype-database;system-pcre2;poll_ppoll;sha3-fast;statx)
    set_property(TARGET Qt5::Core
                 PROPERTY QT_DISABLED_PRIVATE_FEATURES
                 etw;futimes;glib;glibc;gnu-libiconv;iconv;icu;journald;lttng;poll_poll;poll_pollts;poll_select;posix-libiconv;renameat2;slog2;syslog;system-doubleconversion)
    ...
    _populate_Core_target_properties(RELEASE "libQt5Core.so.5.15.14" "" FALSE)
